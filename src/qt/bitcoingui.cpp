...
{
    resize(850, 550);
    setWindowTitle(tr("MiracleCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    notificationsPage = new Notifications(this);
    ...
    centralWidget->addWidget(notificationsPage);
    centralWidget->addWidget(calculatorPage);
    centralWidget->addWidget(botsPage);
    centralWidget->addWidget(marketplacePage);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a MiracleCoin address"));
    ...
    notificationsAction = new QAction(QIcon(":/icons/notifications"), tr("&Notifications"), this);
    notificationsAction->setToolTip(tr("Bittrex notifications."));
    notificationsAction->setCheckable(true);
    notificationsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
    tabGroup->addAction(notificationsAction);

    calculatorAction = new QAction(QIcon(":/icons/calculator"), tr("&Calculator"), this);
    calculatorAction->setToolTip(tr("Show coin price calculator."));
    calculatorAction->setCheckable(true);
    calculatorAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_7));
    tabGroup->addAction(calculatorAction);

    marketplaceAction = new QAction(QIcon(":/icons/marketplace"), tr("&Marketplace"), this);
    marketplaceAction->setToolTip(tr("Show marketplace page."));
    marketplaceAction->setCheckable(true);
    marketplaceAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_8));
    tabGroup->addAction(marketplaceAction);

    botsAction = new QAction(QIcon(":/icons/bots"), tr("&Bots"), this);
    botsAction->setToolTip(tr("Show bots page."));
    botsAction->setCheckable(true);
    botsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_9));
    tabGroup->addAction(botsAction);
    ...
    connect(notificationsAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(notificationsAction, SIGNAL(triggered()), this, SLOT(gotoNotificationsPage()));
    ...
    connect(marketplaceAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(marketplaceAction, SIGNAL(triggered()), this, SLOT(gotoMarketplacePage()));
    connect(botsAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(botsAction, SIGNAL(triggered()), this, SLOT(gotoBotsPage()));

    quitAction = new QAction(QIcon(":/icons/quit"), tr("E&xit"), this);
    quitAction->setToolTip(tr("Quit application"));
    quitAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_Q));
    quitAction->setMenuRole(QAction::QuitRole);
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About MiracleCoin"), this);
    aboutAction->setToolTip(tr("Show information about MiracleCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for MiracleCoin"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->addAction(notificationsAction);
    toolbar->addAction(calculatorAction);
    toolbar->addAction(marketplaceAction);
    toolbar->addAction(botsAction);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("MiracleCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::setWalletModel(WalletModel *walletModel)
{
    ...
    if(walletModel)
    {
        ...
        notificationsPage->setModel(walletModel);
        calculatorPage->setModel(walletModel);
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("MiracleCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MiracleCoin network.", "", count));
}
...
void BitcoinGUI::gotoNotificationsPage()
{
    notificationsAction->setChecked(true);
    centralWidget->setCurrentWidget(notificationsPage);
...
{
  calculatorAction->setChecked(true);
  centralWidget->setCurrentWidget(calculatorPage);

  exportAction->setEnabled(false);
  disconnect(exportAction, SIGNAL(triggered()), 0, 0);
}

void BitcoinGUI::gotoMarketplacePage()
{
  marketplaceAction->setChecked(true);
  centralWidget->setCurrentWidget(marketplacePage);

  exportAction->setEnabled(false);
  disconnect(exportAction, SIGNAL(triggered()), 0, 0);
}

void BitcoinGUI::gotoBotsPage()
{
  botsAction->setChecked(true);
  centralWidget->setCurrentWidget(botsPage);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid MiracleCoin address or malformed URI parameters."));
    }
...
void BitcoinGUI::setStyle(const QString& fileName)
{
    QFile f(fileName);
    ...
    {
        uiInterface.ThreadSafeMessageBox("Error loading style from file.", _("MiracleCoin"), CClientUIInterface::OK | CClientUIInterface::ICON_ERROR | CClientUIInterface::MODAL);
    }
}
