...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case NotificationsEnabled:
          return QVariant(fNotificationsEnabled);
        case NotificationsOpenPageEnabled:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case CoinControlFeatures: {
            ...
            break;
        case NotificationsEnabled:
            fNotificationsEnabled = value.toBool();
            settings.setValue("fNotificationsEnabled", fNotificationsEnabled);
            emit notificationsEnabledChanged(fNotificationsEnabled);
            break;
        case NotificationsOpenPageEnabled:
            fNotificationsOpenPageEnabled = value.toBool();
            settings.setValue("fNotificationsOpenPageEnabled", fNotificationsOpenPageEnabled);
            break;
        case NotificationsOpenPageUrl:
